  ...
  return (
    <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_1.1fr] lg:gap-16">
        ...
        {phases.map((phase, i) => {
          ...
          return (
            <button
              ...
              type="button"
              onClick={() => setActive(i)}
              className="group relative flex min-h-[145px] items-center gap-4 py-6 text-left sm:min-h-[190px] sm:py-8"
            >
              <span
                className={`mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-xs font-bold transition-colors duration-300 ${
                  isActive
              ...
              <span className="flex-1">
                ...
                <span
                  className={`mt-1 block font-semibold transition-colors duration-300 ${
                    isActive
                      ? "text-lg text-empirika-ink sm:text-xl"
      ...
      <div className="relative lg:sticky lg:top-32 lg:self-start">
        <div className="min-h-[380px] overflow-hidden rounded-2xl border border-white/10 bg-empirika-ink text-white shadow-[0_40px_80px_-40px_rgba(0,0,0,0.5)] sm:min-h-[420px]">
          ...
          <div key={active} className="p-7 sm:p-10" style={{ animation: "methodology-fade 0.5s ease" }}>
            ...
            <div className="mt-9 h-1.5 w-full overflow-hidden rounded-full bg-white/10">
              <div
